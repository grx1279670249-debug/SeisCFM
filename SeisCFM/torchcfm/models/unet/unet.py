...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        self.out = conv_nd(dims, ch, out_channels, 3, padding=1)

        self.out_gain = nn.Parameter(th.ones(1, out_channels, 1, 1))
        self.out_bias = nn.Parameter(th.zeros(1, out_channels, 1, 1))
    ...
    def forward(self, t, x, y=None):
        ...
        y = self.out(h)
        return y * self.out_gain + self.out_bias
